...
<form class="login-form" action="signupe" method="post">
  <h1>Employee Sign Up</h1>
  <div class="form-input-material">
    <input type="text" name="username" id="username" placeholder="email" autocomplete="off" class="form-control-material" required />
    <label for="username">Email</label>
  </div>
  <div class="form-input-material">
    <input type="text" name="name" id="username" placeholder="Enter your fullname" autocomplete="off" class="form-control-material" required />
    <label for="username">Full Name</label>
  </div>
  <div class="form-input-material">
    <input type="password" name="password" id="password" placeholder="Must be in Number" autocomplete="off" class="form-control-material" required />
    <label for="password">Password</label>
  </div>
  <div class="form-input-material">
    <input type="date" name="date" id="username" placeholder="" autocomplete="off" class="form-control-material" id="date" required />
    <label for="date"></label>
  </div>
  <button type="submit" class="btn btn-primary btn-ghost">Submit</button>  
  <button type="submit" class="btn btn-primary btn-ghost"><a href="loginemployee.jsp">Login</a></button>
